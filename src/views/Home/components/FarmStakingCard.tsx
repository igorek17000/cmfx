  ...
  return (
    <StyledFarmStakingCard>
      <CardBody>
        ...
        <CardImage
          src="/images/pools/cmfx-cmfx.svg"
          alt="cmfx logo"
          width={64}
          height={64}
        />
        <Block>
          <Label>{TranslateString(544, 'CMFX to Harvest')}:</Label>
          <CakeHarvestBalance />
        </Block>
        <Block>
          <Label>{TranslateString(546, 'CMFX in Wallet')}:</Label>
          <CakeWalletBalance />
        </Block>
        <Actions>
          {account ? (
            ...
            >
              {pendingTx
                ? TranslateString(548, 'Collecting CMFX')
                : TranslateString(
                    532,
