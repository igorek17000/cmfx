      ...
      <Grid>
        ...
        <GridItem>
          <Text
            ...
            mb="20px"
          >
            {TranslateString(864, 'CMFX per $1000')}
          </Text>
        </GridItem>
        {/* 1 day row */}
        <GridItem>
