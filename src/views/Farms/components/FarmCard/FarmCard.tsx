...
const FarmCard: React.FC<FarmCardProps> = ({
  ...
  // NAR-CAKE LP. The images should be cake-bnb.svg, link-bnb.svg, nar-versa.svg
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'CMFX';
  ...
  return (
    <FCard>
      {farm.pid === 1 ? <StyledCardAccent /> : null}
      <CardHeading
        lpLabel={lpLabel}
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        <DetailsSection
          removed={removed}
          bscScanAddress={`https://blockscout.com/astar/address/${
