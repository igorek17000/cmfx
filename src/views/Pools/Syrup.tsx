...
import { Heading } from '../../packages/@pancakeswap-libs/uikit';
      ...
      <Hero>
        <div>
          <Heading as="h1" size="xxl" mb="16px">
            {TranslateString(738, 'Syrup Pool on CMFX')}
          </Heading>
          <ul>
            <li>
              {TranslateString(580, 'Stake CMFX to earn new tokens.')}
            </li>
            <li>
